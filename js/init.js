...
skel.init({
	reset: 'full',
	breakpoints: {
		global:		{ range: '*', href: 'sites/all/themes/twenty/css/style.css', containers: 1400, grid: { gutters: 50 } },
		wide:		{ range: '-1680', href: 'sites/all/themes/twenty/css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
		normal:		{ range: '-1280', href: 'sites/all/themes/twenty/css/style-normal.css', containers: 960, lockViewport: true },
		narrow:		{ range: '-980', href: 'sites/all/themes/twenty/css/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
		narrower:	{ range: '-840', href: 'sites/all/themes/twenty/css/style-narrower.css', grid: { collapse: 1 } },
		mobile:		{ range: '-640', href: 'sites/all/themes/twenty/css/style-mobile.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
	}
}, {
	layers: {
